...
import { Settings, Zap, User, ChevronDown, LogOut } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
      <div className="flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto">
        ...
        >
          {/* LOGO */}
          <div className="relative w-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50  group-hover:scale-105 transition-all duration-300">
        ...
        <div className="flex items-center gap-4">
          ...
          <div ref={menuref} className="relative">
            <button
              className="flex items-center gap-2 px-3 py-2 cursor-pointer transition-colors duration-300 hover:bg-purple-50 rounded-full border-border-transparent hover:border-purple-200"
            ...
            {menuOpen && (
              <ul className="absolute top-14 right-0 bg-white rounded-2xl shadow-xl border border-purple-100 overflow-hidden animate-fadeIn">
                <li className="p-2">
                  <button onClick={() => {
                    setMenuOpen(false)
                    navigate('/profile')
