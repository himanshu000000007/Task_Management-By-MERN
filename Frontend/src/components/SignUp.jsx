...
const SignUp = ({onSwitchMode}) => {
 ...
 const handleSubmit = async (e)=>{
  ...
  try {
    ...
    setMessage({text: "Registration successfull! you can log in.", type:"success"})
    ...
    <div className='max-w-md w-full bg-white shadow-lg border border-purple-100 rounded-xl p-8'>
      <div className='mb-6 text-center'>
        ...
        <p className='text-gray-500 text-sm mt-1'>
          Join Taskify & Manage Your Tasks
        </p>
      </div>
      {message.text && (
      ...
      <form onSubmit={handleSubmit} className='space-y-4'>
        ...
        <button onClick={onSwitchMode} className='text-purple-600 hover:text-purple-700 hover:undeline font-medium transition-colors' >
          Login
